...
enum TokenType {
    TK_NUMBER, TK_ID, TK_STRING, TK_ASSIGN, TK_LPAREN, TK_RPAREN, TK_LCURLY, TK_RCURLY, TK_COMA,
    TK_PLUS, TK_MINUS, TK_MULT, TK_DIV, TK_EQU, TK_NEQ, TK_LT, TK_LTE, TK_GT, TK_GTE, 
    TK_PRINT, TK_WHILE, TK_IF, TK_ELSE, TK_DEFINE, TK_RETURN, TK_VAR, TK_TRUE, TK_FALSE, TK_NOT, TK_SEMI,
